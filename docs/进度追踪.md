...
| 项 | 状态 | 预估人天 |
| --- | --- | --- |
| 中心 Prometheus 集群搭建（**3 个手写 Helm chart** + HA + 存储 + Alertmanager + **istio HTTPS 入口**） | 🔄 进行中：3 个 chart + values + ArgoCD Application 已本地就绪并通过渲染验证，待评审 | 5～8 |
